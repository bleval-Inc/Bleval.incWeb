export function userConfirmationEmail({ name, email, phone, message }) {
  return {
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a">
        ...
        <table style="width:100%;border-collapse:collapse">
          <tr><td style="padding:6px 0;font-weight:bold;width:120px">Email</td><td><a href="mailto:${email}">${email}</a></td></tr>
