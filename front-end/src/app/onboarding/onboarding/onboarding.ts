...
export class OnboardingOnboarding implements OnInit, OnDestroy {
  ...
  readonly planMeta = computed(() => {
    ...
    const meta: Record<OnboardingPlan, {
      ...
      foundation: {
        name: 'Foundation',
        positioning: 'The essential high-performance launchpad designed to turn your first visitors into loyal customers.',
        timeline: '2–3 weeks',
        price: 6000,
        monthly: 999,
        included: [
          '5 high-conversion pages',
        ...
        toneKicker: 'Launch with credibility, speed, and momentum.',
      },
      acceleration: {
        name: 'Acceleration',
        positioning: 'A high-velocity growth engine that leverages AI and automation to scale your digital presence and dramatically increase lead generation.',
        timeline: '3–4 weeks',
        price: 9000,
        monthly: 1500,
        included: [
          '8 conversion-optimized pages',
          'AI chatbot + WhatsApp flows',
          'Lead nurturing automation',
          'Content + SEO system',
          'Foundation + acceleration tools',
          'A/B testing + CRO',
          'Advanced analytics suite',
          'Quarterly growth audit',
          'Everything included in Foundation',
        ],
        toneKicker: 'Automate engagement. Convert on demand.',
      },
      enterprise: {
        name: 'Enterprise',
        positioning: 'The ultimate all-in-one revenue ecosystem for ambitious brands seeking a fully integrated high-performance digital infrastructure.',
        timeline: '4–5 weeks',
        price: 12000,
        monthly: 1999,
        included: [
          ...
          'Enterprise SEO + velocity systems',
          'Acceleration + enterprise tools',
          '24/7 system monitoring',
          'Monthly ROI optimization',
          'Accountable strategic partnership',
          'Everything included in Foundation + Acceleration',
        ],
        toneKicker: 'Operate like an elite 24/7 digital growth team.',
      },
    }
    return meta[plan]
  })
